...
class ItemsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.appBarItems.includedLayoutContent.listItems.layoutManager = LinearLayoutManager(this)
        binding.appBarItems.includedLayoutContent.listItems.adapter = NoteRecyclerAdapter(this, DataManager.notes)
